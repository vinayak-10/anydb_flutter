...
class MetaDefault extends GenInterface {
  ...
  void populate(Map<String, dynamic> jsonDb) {
    if (jsonDb.containsKey('__meta__')) {
      ...
      if (meta.containsKey('u')) updated = DateTime.fromMillisecondsSinceEpoch(meta['u']);
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text("Book-keeping Info", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.blueGrey)),
            const Divider(),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(DateFormat('yMMMd, HH:mm').format(dt), style: TextStyle(color: color, fontWeight: FontWeight.bold, fontSize: 13)),
        ],
      ),
    );
  }
